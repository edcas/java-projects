...
import com.company.examples.lambda.interfaces.BookPageFilter;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // filter(books, booksFilter, (Book book) -> book.getPrice() > 15);
        filter(books, booksFilter, (Book book) -> book.getPages() > 400);
